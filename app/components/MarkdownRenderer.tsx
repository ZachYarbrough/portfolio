    ...
    return (
        <Markdown options={{
            overrides: {
                ...
                img: { component: (props) => <Image src={props.src} alt={props.alt} imgStyle={{ width: '100%', height: '100%', borderRadius: '0.5rem', border: '1px solid var(--secondary-light)' }} hideModal={true} /> }
            }
        }}>
            {content}
        </Markdown>
