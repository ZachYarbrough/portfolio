...
export const ExternalLinkIcon = () => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" fill="currentColor" aria-hidden="true" data-slot="icon" style={{ margin: '0 0 0 0.1rem', width: '0.7rem', height: '0.7rem', display: 'inherit' }}>
...
export const ArrowRightIcon = () => (
 ...
 export const NavArrowRightIcon = () => (
	...
	<path d="M5 3l6 5-6 5" stroke="currentColor" strokeWidth="2.5" fill="none" strokeLinecap="round" strokeLinejoin="round"/>
    </svg>
)
...
export const SearchIcon = () => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" style={{ margin: '0 0 0 0.5rem', width: '1rem', height: '1rem', display: 'inherit' }}>
...
export const LocationPinIcon = () => (
  ...
  >
    <path
      ...
      d="M12 21s6-5.373 6-10.5A6 6 0 0 0 6 10.5C6 15.627 12 21 12 21Z"
    />
